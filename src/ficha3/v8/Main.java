...
public class Main {
    public static void main(String[] args) {
        ...
        Movie m1 = new Movie("The Matrix", new Price(Price.Code.REGULAR));
        Movie m2 = new Movie("Toy Story", new Price(Price.Code.CHILDRENS));
        Movie m3 = new Movie("Avengers: Endgame", new Price(Price.Code.NEW_RELEASE));
