...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Test the output of the statement() function
        System.out.println("Plain text statement:\n" + customer.statement());

        // Test the output of the htmlStatement() function
        System.out.println("\nHTML formatted statement:\n" + customer.htmlStatement());

        // Verify the calculation of total amount and frequent renter points
